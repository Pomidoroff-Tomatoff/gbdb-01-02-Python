...
#    Сложение. 
        Объединение двух клеток (тканей). 
        При этом число ячеек (клеток) общей клетки должно равняться сумме ячеек исходных двух клеток.
#    Вычитание. 
        Участвуют две клетки (ткани). 
        Операцию необходимо выполнять только если разность количества ячеек (клеток) двух клеток (тканей) больше нуля, иначе выводить соответствующее сообщение.
#    Умножение. 
        Создается общая клетка (ткань) из двух. 
        Число ячеек (клеток) общей клетки (ткани) определяется как произведение количества ячеек (клеток) этих двух клеток (тканей).
#    Деление. 
        Создается общая клетка (ткань) из двух. 
        Число ячеек (клеток) общей клетки (ткани) определяется как цело-численное деление количества ячеек (клеток) этих двух клеток (тканей).
